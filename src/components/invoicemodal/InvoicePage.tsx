...
const InvoicePage: React.FC<ModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className=" inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4 sm:p-6">
      <div className="relative max-w-6xl mx-auto bg-white p-6 rounded-lg shadow-lg w-full">
        <button
