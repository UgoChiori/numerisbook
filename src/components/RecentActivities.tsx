...
//               src={activity.avatar}
//               alt={activity.user}
//               className="w-10 h-10 md:w-12 md:h-12 rounded-full mr-2 md:mr-4 mb-2 md:mt-[-80px]"
//             />
//             <div className="flex flex-col justify-center items-start gap-2 border border-black">
...
//               <div className="bg-[#F6F8FA] rounded-[16px] p-[16px] mt-2 md:mt-2  w-[303px]">
//                 <p className="text-xs md:text-sm ">
//                 <span className="text-[#697598]"> Created invoice</span>  <span className="font-400 text-[14px]">{activity.invoiceId}</span> /{' '}
//                   {activity.user}
//                 </p>
//               </div>
//             </div>
        ...
        {activities.map((activity, index) => (
          ...
          >
            ...
            <div className="flex flex-col justify-center items-start gap-2">
              <p className="font-[500] text-sm md:text-[18px] text-[#000000]">{activity.description}</p>
              <p className="text-[#697598] text-xs md:text-[14px] font-[400]">{activity.time}</p>
              <div className="bg-[#F6F8FA] rounded-[16px] p-[16px]  mt-2 w-full max-w-[300px]">
                <p className="text-xs md:text-sm ">
                  <span className="text-[#697598]">Created invoice</span>
                  <span className="font-400 text-[14px]"> {activity.invoiceId}</span> /{' '}
                  {activity.user}
                </p>
              </div>
            </div>
